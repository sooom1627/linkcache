...
| 検証記録                                | [dashboard-overview-us-a.md](./dashboard-overview-us-a.md) §5（T1〜T8 サマリ）、§6 T7・T8                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
**US-A（ダッシュ概要 RPC）**: [`fetchDashboardOverview.api.ts`](../../src/features/links/api/fetchDashboardOverview.api.ts) を追加済み（`dashboardOverviewRpcSchema`・`fetchDashboardOverview(pTz)`）。検証記録は [dashboard-overview-us-a.md §5](./dashboard-overview-us-a.md#5-実装済みt1t8サマリ)（T4 含む）。
