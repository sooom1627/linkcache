...
**実装進捗（要約）**: ユーザーストーリー **US-A**（週次グラフの `daily_totals`・T1〜T9）は **完了**（[dashboard-overview-us-a.md](./dashboard-overview-us-a.md)）。**US-B**（`daily_by_collection`・collection_table・B1〜B7、共有 fixtures と品質ゲート含む）は **完了**（[dashboard-overview-us-b.md](./dashboard-overview-us-b.md)）。**US-C**（ドメイン内訳・`daily_by_domain`）の**コード実装は未**；垂直分割の実行計画・DoD・RPC 契約は [dashboard-overview-us-c.md](./dashboard-overview-us-c.md)（C1〜C7）。レジリエンス・引っ張り更新（**US-X**）は未。
...
| 項目                                    | 状態                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| --------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| RPC `get_dashboard_overview(p_tz text)` | **実装済み**（`daily_totals` §2 どおり；**`daily_by_collection` は B1 で実データ**（形状は [US-B §3](./dashboard-overview-us-b.md)）；`daily_by_domain` は当面 `[]` — **埋める手順は [US-C](./dashboard-overview-us-c.md#us-c-rpc-contract)**）                                                                                                                                                                                                                                                                                                                              |
| リポジトリ DDL                          | 起点 [`20260322000000_get_dashboard_overview.sql`](../../supabase/migrations/20260322000000_get_dashboard_overview.sql) → [`20260322032918_dashboard_overview_seven_day_timestamp_filter.sql`](../../supabase/migrations/20260322032918_dashboard_overview_seven_day_timestamp_filter.sql) → **`daily_by_collection`**: [`20260322074231_get_dashboard_overview_daily_by_collection.sql`](../../supabase/migrations/20260322074231_get_dashboard_overview_daily_by_collection.sql)                                                                                           |
...
| 検証記録                                | [dashboard-overview-us-a.md](./dashboard-overview-us-a.md) §5（T1〜T9 サマリ）、§6（T6〜T9）；コレクション内訳（B1〜B7）は [dashboard-overview-us-b.md](./dashboard-overview-us-b.md) §5・§6；**US-C**（`daily_by_domain`・未実装）のタスク・DoD は [dashboard-overview-us-c.md](./dashboard-overview-us-c.md) §5・§6                                                                                                                                                                                                                                                        |
