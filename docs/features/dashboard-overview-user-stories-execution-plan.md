...
| **US-B** | collection_table（コレクション別内訳）             | [`DashboardBreakdownSection`](../../src/features/links/components/dashboard/DashboardBreakdownSection.tsx) で `tableView === "collection"`、`daily_by_collection`、§2 の重複計上。実行タスク一覧: [dashboard-overview-us-b.md](./dashboard-overview-us-b.md) | §2 コレクション、§3.2、§6                                 |
