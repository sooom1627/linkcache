-- US-C C1: Populate daily_by_domain (triage_status new/done only; extractDomain-equivalent host;
-- top 15 domains by 7-day (added+read) activity with rollup to __other__).
-- daily_totals and daily_by_collection bodies match 20260322080212 (unchanged semantics).
